    ...
    -- Neotest setup
    {
        ...
        opts = function(_, opts)
            ...
            opts.adapters["neotest-golang"] = {
                -- standart way to configure go tests from the neotest-golang
                --go_test_args = {
                --    "-v", -- necessary for neotest-golang
                --    "-coverprofile=" .. vim.fn.getcwd() .. "/coverage.out",
                --},
                -- this command follows the integration test standart
                go_test_args = {
                    "-v", -- necessary for neotest-golang
                    "-covermode=atomic",
                    "-coverpkg=./...",
        ...
        keys = {
            ...
            { "<leader>to", function() require("neotest").output.open({ enter = true, auto_close = false, last_run = true }) end, desc = "[t]est [o]utput" },
